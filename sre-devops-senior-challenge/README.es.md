...
El equipo de desarrollo reportó el día **10 de noviembre** que un endpoint de **API Gateway + Lambda** está tardando más de 5 segundos en responder, pero **no todo el tiempo**. La Lambda accede a una **tabla DynamoDB** para realizar operaciones.

**Debes revisar las métricas históricas desde el 10 de noviembre** para investigar el problema y probar el endpoint nuevamente para ver el funcionamiento actual.
