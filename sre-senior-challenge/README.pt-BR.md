...
A equipe de desenvolvimento relata que um endpoint de **API Gateway + Lambda** está demorando mais de 5 segundos para responder, mas **não o tempo todo**. A Lambda acessa uma **tabela DynamoDB** para realizar operações.
